...
void ws2812b_setup() {
    ...
    // initialize RB13 as output pin / off
    TRISBbits.TRISB13 = 0;
    LATBbits.LATB13 = 0;
}
...
void ws2812b_setColor(wsColor * c, int numLEDs) {
    ...
    volatile unsigned int delay_times[2*3*8 * 10]; // I only gave you 5 WS2812B, adjust this if you get more somewhere
