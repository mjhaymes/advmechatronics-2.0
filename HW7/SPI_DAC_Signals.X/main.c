...
// DEVCFG1
#pragma config FNOSC = FRCPLL // use internal 8MHz oscillator
#pragma config FSOSCEN = OFF // disable secondary oscillator
#pragma config IESO = OFF // disable switching clocks
#pragma config POSCMOD = OFF // high speed crystal mode off
...
// DEVCFG2 - get the sysclk clock to 48MHz from the 8MHz internal oscillator
